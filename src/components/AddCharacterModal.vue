<template>
  <div class="add-character-modal-wrapper" :class="{ active }">
    <div class="modal-box">
      ...
      <div class="text">
        <p>Saisissez le nom et la série du personnage que vous souhaitez ajouter.</p>
        <div class="form">
          <div class="form-group">
            <label> Character Name </label>
            <input type="text" v-model="characterName" />
            <p v-if="characterOrDefault.canonicalName">
              Nom de personnage trouvé : {{ characterOrDefault.canonicalName }}
            </p>
          </div>
          <div class="form-group">
            <label> Series </label>
            ...
            <p v-if="characterOrDefault.series">
              Série trouvée : {{ characterOrDefault.series }}
            </p>
          </div>
...
export default {
  props: {
    text: {
      type: String,
      default: "Vous êtes sûr ?",
    },
    confirmText: {
      type: String,
      default: "Ajouter un personnage",
    },
    cancelText: {
      type: String,
      default: "Annuler",
