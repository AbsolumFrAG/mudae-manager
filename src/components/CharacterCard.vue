<template>
  <div class="character-card-container" @click.stop="showModal">
    <div class="character-card" :class="{ divorcing }">
      <div class="image" :style="'background-image:url(\' ' + characterImage + ' \')'">
        ...
        <div class="action-icons">
          ...
          <div class="action-icon divorce" :title="
            divorcing ? 'Retirer de la liste des divorces' : 'Ajouter à la liste des divorces'
          " @click.stop="divorceCharacter">
            <i class="bi" :class="divorcing ? 'bi-heartbreak-fill' : 'bi-heartbreak'"></i>
          </div>
        </div>
        <div class="loadingText" v-if="loading">Chargement...</div>
